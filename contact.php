                ...
                <div class="row contact-us">
                    <div class="max-content clearfix">
                        ...
                        <div class="col-xs-6">
                            <div class="row row-contact">
                                ...
                                <p class="contcat-p">
                                    ...
                                    <span>шоссе Революции, 31 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; офис - центральный вход &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; склад - с правой стороны за крыльцом</span>
                                </p>
                                <p class="contcat-p">
                        ...
                        <div class="col-xs-6">
							...
							<img src="img/sxema.jpg" width="100%" style="padding-bottom: 15px;">
							
                                <script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?sid=eLinI-utSpNfU2HVP7Fjr96-u8s_XYoW&width=445&height=300&lang=ru_RU&sourceType=constructor&scroll=true"></script>			 
